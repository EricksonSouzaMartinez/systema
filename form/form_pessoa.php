...
?>
    ...
    <div class="corpo">
            <form calss="container cadastro" action="/../public/adiciona_pessoa.php" method="POST">
                ...
                <label for="ttel">Telefone:</label>
                        <input class="ctel" name="ttel" type="tel" id="itel" maxlength="11" placeholder="Digite o telefone"><br>
